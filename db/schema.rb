...
ActiveRecord::Schema.define(version: 20160828100014) do
  ...
  add_index "trainings", ["language_id"], name: "index_trainings_on_language_id", using: :btree
  ...
  add_foreign_key "trainings", "languages"
end
